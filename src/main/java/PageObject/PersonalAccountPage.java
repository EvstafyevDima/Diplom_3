...
public class PersonalAccountPage {
    ...
    @Description("Click the log out button")
    public void clickTheLogOutButton() {
        logOutButton.click();
    }

    //Нажать на кнопку "Конструктор"
    @Description("Click the constructor button")
